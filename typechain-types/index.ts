...
export type { ProposalRegistry } from "./src/ProposalRegistry";
export { ProposalRegistry__factory } from "./factories/src/ProposalRegistry__factory";
export type { ZKRegistry } from "./src/ZKRegistry";
export { ZKRegistry__factory } from "./factories/src/ZKRegistry__factory";
