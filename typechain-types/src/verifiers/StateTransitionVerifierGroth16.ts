...
export interface StateTransitionVerifierGroth16Interface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "verifyProof(bytes,uint256[8])",
...
export interface StateTransitionVerifierGroth16 extends BaseContract {
  ...
  "verifyProof(bytes,uint256[8])": TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "verifyProof(bytes,uint256[8])"
  ): TypedContractMethod<
    [proof: BytesLike, input: BigNumberish[]],
    [void],
    "view"
