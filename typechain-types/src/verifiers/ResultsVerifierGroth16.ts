...
export interface ResultsVerifierGroth16Interface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "verifyProof(bytes,uint256[9])",
...
export interface ResultsVerifierGroth16 extends BaseContract {
  ...
  "verifyProof(bytes,uint256[9])": TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "verifyProof(bytes,uint256[9])"
  ): TypedContractMethod<
    [proof: BytesLike, input: BigNumberish[]],
    [void],
    "view"
